// <copyright file="Vector3IntArraySerializer.cs" company="Firoozeh Technology LTD">
...
namespace Plugins.GameService.Utils.RealTimeUtil.Models.UnitySerializerModels.Miscs
{
    ...
    internal class Vector3IntArraySerializer : ObjectSerializer<Vector3Int[]>
    {
        ...
        protected override Vector3Int[] ReadObject(GsReadStream readStream)
        {
            ...
            var data = new Vector3Int[readData.Length / Base];
            
            for (var i = 0; i < readData.Length; i += Base)
                data[i / Base] = new Vector3Int(readData[i],readData[i + 1],readData[i + 2]);
