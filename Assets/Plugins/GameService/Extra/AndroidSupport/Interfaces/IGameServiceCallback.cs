...
using Plugins.GameService.Utils.AndroidSupport.Core;
using UnityEngine;
...
namespace Plugins.GameService.Utils.AndroidSupport.Interfaces
{
    /// <summary>
    /// Represents GameService  Internal interface
    /// </summary>
    internal class IGameServiceCallback : AndroidJavaProxy
    {

        private readonly DelegateCore.OnCallback _oncallback;
        private readonly DelegateCore.OnError _onError;

        internal IGameServiceCallback(DelegateCore.OnCallback callback, DelegateCore.OnError onError)
